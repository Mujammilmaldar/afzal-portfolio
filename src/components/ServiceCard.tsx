...
export default function ServiceCard({
  ...
  return (
    <div className="cards-style">
      <div className="main-card-service group p-2 py-5 md:p-5 lg:p-10 relative shadow-sm hover:shadow-md transition flex gap-4 overflow-hidden cursor-pointer">
        ...
        <div className="down-side-content absolute">
          <div className="card-heading text-center">
            <h3 className="text-white! text-2xl!">Card Benefits for Afzal Sir</h3>
          </div>
